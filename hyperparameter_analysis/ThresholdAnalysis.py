...
def threshold_distribution():
    ...
    print("85% at threshold: ", np.percentile(thresholds, 85))
    print("90% at threshold: ", np.percentile(thresholds, 90))
    print("95% at threshold: ", np.percentile(thresholds, 95))
    print("96% at threshold: ", np.percentile(thresholds, 96))
    print("97% at threshold: ", np.percentile(thresholds, 97))
    print("98% at threshold: ", np.percentile(thresholds, 98))
