...
from FOAnalysis import get_pairs, get_co_changed_smelly_pairs
from Utility import read_filename_pairs, get_project_smells_in_range, sort_tuple_elements, order_file1_and_file2, \
...
def print_overlap_dtw():
    ...
    # Get raw smell pairs
    smell_pairs_with_date = order_file1_and_file2(get_project_smells_in_range(False))
    ...
    overlapping_pairs = to_unique_file_tuples(get_co_changed_smelly_pairs(dtw_cc_pairs, smell_pairs_with_date))
...
def print_overlap_mba():
    ...
    overlapping_pairs = to_unique_file_tuples(get_co_changed_smelly_pairs(mba_cc_pairs, smell_pairs_with_date))
